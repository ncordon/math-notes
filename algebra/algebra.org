...
#+begin_definition
Una extensión $E/K$ se llama extensión de Galois si exsite un grupo $G < Aut(E)$ tal que $E^{G}=K$. En este caso, el grupo se representa por $Gal(E/K)$ y se llama grupo de Galois de la extensión $E/K$
#+end_definition

...
Entonces $K[X_1 \ldots X_n]/I \cong K[X_j : j\notin \{i_1,\lxdots i_s\}]$ es un DI. Luego $I$ es primo.
...
#+begin_fact
En las condiciones de la proposición anterior si $F_i/K_i$ son extensiones algebraicas, $\tau : F_1 \rightarrow F_2$ un homomorfismo sobre $\sigma$ y $u\in F_1$ una raíz de $f_1$. Entonces $\tau(u)$ es una raíz de $f_2 = \sigma(f_1)$
#+end_fact

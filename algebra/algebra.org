...
#+begin_fact
*Un cuerpo de descomposción no tiene extensiones algebraicas propias*

Sea $K$ cuerpo. Equivalen:

1. Todo polinomio no constante tiene al menos una raíz en $K[X]$
2. Todo polinomio no constante descompone en $K$
3. Los polinomios no constantes irreducibles son de grado 1

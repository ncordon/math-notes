...
La isomorfía se da porque dados dos cuerpos con $p$ elementos, tendría grupo multiplicativo cíclico de orden $q-1$, ambos serían cuerpo de descomposición de $X^q - X$ sobre $\mathbb{Z}_p$, luego isomorfos.
#+end_proof

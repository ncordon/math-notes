...
function err = poissonErrorEx2(N)
  ...
  e = ones(N, 1);
  % [-1 0 1] indicates order of diags, where -1 is the lower-diagonal, 0 is the main diagonal and 1 is the upper-diagonal
...
#+begin_src octave :session :results file :exports results :tangle ejercicio2.m
Ns = 1:1:100
hs = 1./(Ns + 1)
...
#+RESULTS[b7b47182c14f0f3ca9fe08a795e119496bc9c68d]:
[[file:ejercicio2.png]]
...
#+begin_src octave :session :results file :exports results :tangle ejercicio3.m

...
5. *Modulación*: Sea $f \in L^1(\mathbb{R}, \mathbb{C}), h\in \mathbb{R}, g(x) = f(x)e^{2\pi hx}$. Entonces:
\[\hat{g}(\xi) = \tau_h \hat{f}(\xi)\]
6. *Dilatación*: Sea $f\in L^1(\mathbb{R}, \mathbb{C}), \lambda \in \mathbb{R}^{+}, h_{\lambda, f}(x) = f(\lambda x)$. Entonces:
\[\widehat{h_{\lambda,f}}(\xi) = \frac{1}{\lambda} \hat{f} \left(\frac{\xi}{\lambda} \right)\]
7. Si $f\in L^1(\mathbb{R}, \mathbb{C})$ entonces $\hat{f}$ es uniformemente continu y acotada con $||\hat{f}||_{L^{\infty}} \le ||f||_{L^1}$
8. Si $f\in L^1(\mathbb{R}, \mathbb{C})$ es derivable con $f'\in L^1(\mathbb{R}, \mathbb{C})$ entonces:
\[\widehat{(f')}(\xi) = 2\pi i \xi \hat{f}(\xi)\]
9. Si $f\in L^1(\mathbb{R}, \mathbb{C})$ y $xf(x) \in L^1(\mathbb{R}, \mathbb{C})$ entonces $\hat{f}$ es derivable con $(\hat{f})'(\xi) = -2\pi i \widehat{(xf(x))}$
